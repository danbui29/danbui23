...
<body>
    ...
    <div class="container-fluid ">
      ...
      <div class="collapse navbar-collapse d-flex justify-content-center" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item mx-3">
            <a class="nav-link text-danger fw-bolder" href="login.php">Logout</a>
          </li>
        </ul>
      </div>
    </div>
      ...
      <table class="table table-sm table-borderless">
        ...
        <tbody>
          <tr>
            ...
            <td class="width-100">bui dan</td>
            <td> 1951060583</td>
            <td>danmata09@gmail.com</td>
            <td>Nam Dinh</td>
            <td>
  ...
  <!-- Copy right -->
  <div class="bg-danger">
    <p class="text-center py-3 text-light">2020 All right reserved , Food House . Developed By <a href="#">BUI NGUYEN DAN</a></p>
  </div>
